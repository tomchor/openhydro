...
u_boundaries = FieldBoundaryConditions(east = OpenBoundaryCondition(u_east), west = OpenBoundaryCondition(u_west))
w_boundaries = FieldBoundaryConditions(east = OpenBoundaryCondition(w_east), west = OpenBoundaryCondition(w_west)) 
b_boundaries = FieldBoundaryConditions(east = OpenBoundaryCondition(b_east), west = OpenBoundaryCondition(b_west))
